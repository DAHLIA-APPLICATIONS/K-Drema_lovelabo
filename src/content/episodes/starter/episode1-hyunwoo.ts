...
export const starterEpisode1Hyunwoo: Episode = {
  id: 'starter-1-hyunwoo',
  title: '初めての出会い',
  level: 'starter',
  difficulty: 'easy',
  description: '図書館で初めて出会う二人。簡単な挨拶から始まります。',
  characterId: 'hyunwoo',
  characterName: 'ヒョヌ',
  ...
  dialogueNodes: [
    ...
    },
    {
      ...
      speaker: 'character',
      text: {
        korean: '좋은 이름이네요! 저는 현우예요.',
        japanese: '素敵な名前ですね!私はヒョヌです。',
        romanization: 'Joeun ireumineyo! Jeoneun hyunwooyeyo.',
      },
      characterEmotion: 'happy',
      nextNode: 'end',
    },
